...
import gr.oncrete.nick.maintainmeDesktop.BusinessLogic.DeleteCategory;
import gr.oncrete.nick.maintainmeDesktop.BusinessLogic.Categories;
import gr.oncrete.nick.maintainmeDesktop.BusinessLogic.UpdateInfo.UpdateCategoryRecord;
...
public class ManageCategoriesFrame extends javax.swing.JFrame {
     ...
     * @param a
     */
    public ManageCategoriesFrame(JComboBox a) {
        box=a;
        initComponents();
    }
    /**
    ...
    private void initComponents() {
        ...
        catIDComboBox = new javax.swing.JComboBox();
        ...
        jLabel1.setText(bundle.getString("ManageCategoriesFrame.jLabel1.text")); // NOI18N
        westPanel.add(jLabel1);

        jLabel2.setText(bundle.getString("ManageCategoriesFrame.jLabel2.text")); // NOI18N
        westPanel.add(jLabel2);

        jLabel3.setText(bundle.getString("ManageCategoriesFrame.jLabel3.text")); // NOI18N
        ...
        retrieveCategoryButton.setText(bundle.getString("ManageCategoriesFrame.retrieveCategoryButton.text")); // NOI18N
        bottomPanel.add(retrieveCategoryButton);

        goButton.setText(bundle.getString("ManageCategoriesFrame.goButton.text")); // NOI18N
    ...
    private void catActionComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_catActionComboBoxActionPerformed
        ...
        {
            this.catIDComboBox.setEnabled(false);
        } else if (a == 1) //the action is edit
        {
            this.catIDComboBox.setEnabled(true);
    ...
    private void goButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goButtonActionPerformed
        ...
        {
            String oldCatName = (String) this.catIDComboBox.getSelectedItem();
        ...
        {
            String catName = (String) this.catIDComboBox.getSelectedItem();
            if (catName.length() > 0) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ManageCategoriesFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox catIDComboBox;
