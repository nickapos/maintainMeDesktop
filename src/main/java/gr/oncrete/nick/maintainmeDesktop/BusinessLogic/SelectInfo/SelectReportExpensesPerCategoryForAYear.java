 ...
 */
package gr.oncrete.nick.maintainmeDesktop.BusinessLogic.SelectInfo;
 ...
 * @author nickapos
 */
public class SelectReportExpensesPerCategoryForAYear extends SelectAllIDS {
     ...
     * @param year
     */
    public SelectReportExpensesPerCategoryForAYear(String year) {
        if (year.length() > 0) {
